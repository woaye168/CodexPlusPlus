...
export const EN_PLAIN: Record<string, string> = {
  ...
  "认证": "Authentication",
  "管理 ChatGPT 等 OAuth 认证账号。": "Manage ChatGPT and other OAuth accounts.",
  "Codex 应用增强": "Codex App Enhancements",
  "切换第三方时保留官方登录": "Keep official login when switching third-party providers",
  "开启后可在使用第三方 API 时继续使用 Codex 官方插件、手机远程操作等功能。": "When enabled, continue using official Codex plugins and mobile remote features while using third-party APIs.",
  "统一 Codex 会话历史": "Unified Codex session history",
  "开启后官方与第三方会话将出现在同一历史列表中。": "When enabled, official and third-party sessions appear in the same history list.",
  "管理 ChatGPT OAuth 认证账号": "Manage ChatGPT OAuth accounts",
  "管理 ChatGPT 账号": "Manage ChatGPT accounts",
  "认证状态": "Auth status",
  ...
  "使用 ChatGPT 登录": "Login with ChatGPT",
  "添加其他账号": "Add another account",
  "退出所有账号": "Logout all accounts",
  "账号登录成功。": "Account logged in successfully.",
  "已退出所有账号。": "Logged out all accounts.",
  "登录超时，请重试": "Login timed out, please try again",
